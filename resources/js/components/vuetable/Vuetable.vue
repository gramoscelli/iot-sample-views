            ...
            <table :class="['vuetable', css.tableClass, css.tableBodyClass]">
                ...
                <template v-for="(item, itemIndex) in tableData">
                    <tr
                        ...
                        :style="onRowStyle(item, itemIndex)"
...
export default {
    ...
    methods: {
        ...
        onRowStyle (dataItem, index) {

            if (typeof(this.rowStyle) === 'function') {
                return this.rowStyle(dataItem, index)
            }

            return this.rowStyle
        },
        onCellStyle (dataItem, field) {
            var obj = {width: field.width};
            if (typeof(this.cellStyle) === 'function') {
                obj = Object.assign(obj, this.cellStyle(dataItem, field));
            }
            return obj;
        },
